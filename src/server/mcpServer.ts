...
⛔ The code-creating tool actions (d365fo_file action=create/modify, labels action=create/rename/update) WILL NOT RUN until you call this. Read actions (d365fo_file generate, labels search/info) and all investigation/read tools are never blocked.
            ...
            properties: {
              ...
              steps: {
                ...
                items: {
                  type: 'object',
                  properties: {
                    tool: { type: 'string', description: "MCP tool for this step, e.g. 'd365fo_file', 'labels', 'generate_object'." },
