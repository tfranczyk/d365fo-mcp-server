...
$curAdoOrg     = Get-Nested $existingConfig @("mcpServers", "ado-remote-mcp", "args")
if ($null -ne $curAdoOrg) {
    $curAdoOrg = [string]($curAdoOrg | Select-Object -Last 1)
}
...
$adoOrg        = Read-Value "Azure DevOps organization name"          -Current $curAdoOrg      -Default "anegis"
